...
uint256 hashGenesisBlock("0x3250eb0cbdcc2a21cc4ca33bca23112b7e52897c1d713fe8359a3df9a0bff3e5f");
...
const string strMessageMagic = "ManhoKoin Signed Message:\n";
...
{
    int64 nSubsidy = 13 * COIN; //Amt of coins per block
...
static const int64 nTargetTimespan = 4 * 60; // ManhoKoin: 0.35 days    // TIEMPO EN REAJSUTAR LA DIFICULTAD DE LA MINERIA / ES PROPORCIONAL AL NUMERO DE MONEDAS EXISTENTES
static const int64 nTargetSpacing = 30; // ManhoKoin: 10 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal ManhoKoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ManhoKoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	CBlock(hash=14dc23f54de47df79717, PoW=00000aeb1f05fbf0b2fa, ver=1, 			hashPrevBlock=00000000000000000000, hashMerkleRoot=ef7e256a2c, 			nTime=1399574511, nBits=1e0ffff0, nNonce=2086299649, vtx=1)
  	...
  	vMerkleTree: ef7e256a2c */
        ...
        // Genesis block
        const char* pszTimestamp = "primer dia de ManhoKoin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1511026235;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2089925939;
        ...
        assert(block.hashMerkleRoot == uint256("0x01416604d68ccae11009e65d5b2bf828d5292c62f4a953535d66ec2c18a1d8d7"));
